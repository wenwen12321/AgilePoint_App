...
export default class TodaySpecial extends React.Component {
    constructor(props) {
        super(props);
            ...
            <SafeAreaView style={{flex:1}}>
                ...
                >
                    <View style={{ flexDirection: "row",backgroundColor: '#FA5858', justifyContent:"space-between" }}>
                        ...
                        <Text style={styles.stroe}>{this.state.title}</Text>
                        <Text style={styles.stroe,{color:"#FA5858"}}>{this.state.title}</Text>
                    </View>
