...
import { View, TouchableOpacity, StyleSheet, Alert, Image, ImageBackground, TouchableHighlight, ScrollView, AsyncStorage, SafeAreaView, Platform, RefreshControl } from 'react-native';
...
export default class ChangePassword extends React.Component {
    ...
    setStorage = async () => {
        try {
            ...
            // console.log("aaaaauth:"+JSON.stringify(auth));
